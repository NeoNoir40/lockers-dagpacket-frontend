        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <InputField
              label="Colonia"
              value={data.colonia}
              onChange={(e) => onChange({ ...data, colonia: e.target.value })}
              disabled={disabled}
...
export const SenderFormSection = ({
  ...
  const handleKeyPress = (val) => {
    if (activeInput) {
      ...
      onChange({ ...data, [activeInput]: newValue }); // Actualiza el estado con el nuevo valor
    }
  };
    ...
    <div className="w-full bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="grid grid-cols-1 gap-5 w-full">
        ...
        <div className="gap-2 flex">
          <label htmlFor="">Desea asegurar su paquete?</label>
          <InputField
            label="Seguro"
            type="checkbox"
